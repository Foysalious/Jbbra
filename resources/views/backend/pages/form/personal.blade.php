    ...
    <div class="container-fluid">
        ...
        <section class="statistics">
            ...
            <div class="row add-row">
                ...
                @if(App\Personal::where('user_id',Auth::user()->id)->count()<1  )
            ...
            <div class="outfield-area">
                ...
                @foreach($personals as $personal)
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 ">
                            <input type="text" class="form-control" placeholder="{{ $i }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label ">First_Name</label>
                        <div class="col-sm-10 ">
                            <input type="text" class="form-control" id="" name="first_name" placeholder="{{$personal->first_name}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control" placeholder=" {{$personal->middle_name}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Last name</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control" placeholder=" {{$personal->last_name}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Father Name</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control" placeholder=" {{$personal->father_name}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Mother Name</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control" placeholder=" {{$personal->mother_name}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Spouse Name</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->spouse_name}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">National ID</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->nid}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Country</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->country}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Birth Date</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder="{{$personal->b_date}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Age</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->age}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nationality</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->nationality}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Gender</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->gender}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Marital</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->marital}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Religion</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->religion}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Weight</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->weight}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Height</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->height}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Son</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->son}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Daughter</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->daughter}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Passport Issue Date</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->issue_date}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Passport Number</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder=" {{$personal->passNo}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Desired Job 1</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder="{{$personal->d_job1}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Desired Job 2</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder="{{$personal->d_job2}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Desired Job 3</label>
                        <div class="col-sm-10 ">
                        <input type="text" class="form-control"  placeholder="{{$personal->d_job3}}"  readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Image</label>
                        <div class="col-sm-10 ">
                        <img src="{{ asset('images/personal/'. $personal->image) }}"  width="100px" alt="n/a">                        
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Desired Job 3</label>
                        <div class="col-sm-10">
                            ...
                            <div class="modal fade" id="edit{{ $personal->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="false">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title" id="exampleModalLabel">personal</h3>
                                    ...
                                    <form method="post" action="{{ route('personalupdate',$personal->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group row">
                                                <label for="first-name" class="col-sm-12 col-form-label ">First name</label>
                                                <div class="col-sm-12 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="middle-name" class="col-sm-12 col-form-label ">Middle name</label>
                                                <div class="col-sm-12 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="father-name" class="col-sm-12 col-form-label ">Father's name</label>
                                                <div class="col-sm-12 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="mother-name" class="col-sm-12 col-form-label ">Mother's name</label>
                                                <div class="col-sm-12 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="spouse-name" class="col-sm-12 col-form-label ">Spouse's name</label>
                                                <div class="col-sm-12 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="national-id" class="col-sm-12 col-form-label ">National ID</label>
                                                <div class="col-sm-12 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="birth-country" class="col-sm-12 col-form-label ">Birth country</label>
                                                <div class="col-sm-12 ">
                                                    <select id="inputState" class="form-control" name="country">
                                            ...
                                            <div class="form-group row">
                                                <label for="" class="col-sm-12 col-form-label">Marital Status</label>
                                                <div class="col-sm-12 ">
                                                    <select id="" class="form-control" name="marital" required>
                                                        <option value="" selected>Select</option>
                                                        <option value="Married" >Married</option>
                                            ...
                                            <div class="form-group row">
                                                <label for="" class="col-sm-12 col-form-label">Religion</label>
                                                <div class="col-sm-12 ">
                                                    <select id="" class="form-control" name="religion" required>
                                                        <option value="" selected>Select</option>
                                                        <option value="Islam" >Islam</option>
                                            ...
                                            <div class="form-group row">
                                                <label for="" class="col-sm-12 col-form-label">Passport Issue Date</label>
                                                <div class="col-sm-12 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="" class="col-sm-12 col-form-label">Desired Job (Please select three options)</label>
                                                <div class="col-sm-4 ">
                                                    <select id="" class="form-control" name="d_job1" required>
                                                        <option value="select" selected>Desired Job 1</option>
                                                        <option value="0">Web Developer</option>	
